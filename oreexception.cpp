...
void OreException::display()
{
  QString displayString = "Error: ";
  displayString.append(errStr);
  QMaemo5InformationBox::information(0, displayString);
  qWarning() << displayString;
}
